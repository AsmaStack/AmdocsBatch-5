...
public class UserCreationandAuthentication {
	...
	public static void Userlogin()
	{
		...
		System.out.println("1. Don't have an Account? SignUp\n2. Existing User Login");
		...
		if(temp == 2)
		{
			...
			Connection con2 = InventoryManagementSystemprimary.conn;
			 ...
			 try {
		            ...
		            String sql = "SELECT userid, role FROM IMS_users WHERE username = ? AND password = ?";
		            ...
		            if (resultSet.next()) {
		                ...
		                }else if(roles.equals("User"))
		                {
		                	...
		                	System.
		                	out.println("Invalid roles type!");
		                }
		...
		}else if(temp == 1)
		{
			 System.out.println("Choose from following: ");
				...
				try {
					...
					String q2 = "insert into IMS_users(UserID, Username,password,role) values(?,?,?,?)";
