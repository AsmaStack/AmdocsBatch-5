...
public class MenuOpener {
		...
		public static void menu4admin()
		{
			...
			System.out.println("2. IMS_Product Module");
			...
			case 1: 
				...
				System.out.println("1. Update values of IMS_users Table");
				System.out.println("2. Delete values of IMS_users Table");
				System.out.println("3. Read values of IMS_users Table");
			...
			case 2: 
				...
				System.out.println("*** Welcome to IMS_Product Module ***");
				System.out.println("1. Insert values in IMS_Product Table");
				System.out.println("2. Update values of IMS_Product Table");
				System.out.println("3. Delete values of IMS_Product Table");
				System.out.println("4. Read values of IMS_Product Table");
			...
			case 3: 
				...
				System.out.println("1. Insert values in IMS_Orders Table");
				System.out.println("2. Update values of IMS_Orders Table");
				System.out.println("3. Delete values of IMS_Orders Table");
				System.out.println("4. Read values of IMS_Orders Table");
				System.out.println("    ****   ");
				System.out.println("5. Insert values in IMS_OrderItem Table");
				System.out.println("6. Update values of IMS_OrderItem Table");
				System.out.println("7. Delete values of IMS_OrderItem Table");
				System.out.println("8. Read values of IMS_OrderItem Table");
				System.out.println("    ****   ");
				...
				System.out.println("12. Read values of IMS_OrderItem Table");
				ch = sc.nextInt();
		...
		public static void menu4User()
		{
			...
			//System.out.println("** Welcome to IMS_Orders Module ***");
			System.out.println("1. List values of IMS_Product Table");
			System.out.println("2. List values of IMS_Orders Table");
			System.out.println("3. List values of IMS_OrderItem Table");
