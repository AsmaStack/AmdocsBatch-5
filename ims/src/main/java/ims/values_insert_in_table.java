...
public class values_insert_in_table {

	public static void updateProduct()
	{
		Scanner sc = new Scanner(System.in);
		
		System.out.println("========= Updating IMS_Product values in table =======");
	...
	public static void valuesInsertProduct()
	{
		Scanner sc = new Scanner(System.in);
		
		System.out.println("========= Inserting IMS_Product values in table =======");
	...
	public static void valuesInsertStockReport()
	{
        Scanner sc = new Scanner(System.in);
		...
		String q1 = "insert into IMS_StockReport(ReportID,ReportDate,ProductID,Qty) values(?,?,?,?)";
	...
	public static void valuesInsertSalesReport()
	{
        Scanner sc = new Scanner(System.in);
		...
		String q1 = "insert into IMS_SalesReport(ReportID,ProductID,ReportDate,TotalSales,OrderID,OrderItemID) values(?,?,?,?,?,?)";
	...
	public static void valuesInsertStockNotify()
	{
        Scanner sc = new Scanner(System.in);
		...
		String q1 = "insert into IMS_StockNotify(NotifyID,ProductID,NotifyDate) values(?,?,?)";
